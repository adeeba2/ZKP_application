...
async function init_web3() {
    ...
    window.pm.options.address = '0xDc7A0F39475F1c64d9B360978C255e29F52E6Bcf'
    ...
    window.co.options.address = "0x01E84Af36300cDa1aa473ba7ED4a7B7b79D56707"
}
...
function customerPartListManager() {
    toggleActive(this)
    clearActiveExcept(this)
...
function customerProductListManager() {
    toggleActive(this)
    clearActiveExcept(this)
...
export {
    ...
    customerPartListManager, customerProductListManager
};
